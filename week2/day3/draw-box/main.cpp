...
//draw line
    SDL_RenderDrawLine(gRenderer, 20, 20, 620, 20);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0xFF /*G*/, 0x00 /*B*/, 0xFF /*A*/);
//draw line
    SDL_RenderDrawLine(gRenderer, 20, 20, 20, 460);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0x00 /*G*/, 0xFF /*B*/, 0xFF /*A*/);
//draw line
    SDL_RenderDrawLine(gRenderer, 620, 20, 620, 460);

    SDL_SetRenderDrawColor(gRenderer, 0xFF /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0xFF /*A*/);
//draw line
    SDL_RenderDrawLine(gRenderer, 20, 20, 460, 20);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0xFF /*G*/, 0x00 /*B*/, 0xFF /*A*/);
//draw line
    SDL_RenderDrawLine(gRenderer, 20, 20, 20, 620);

    SDL_SetRenderDrawColor(gRenderer, 0xFF /*R*/, 0x00 /*G*/, 0xFF /*B*/, 0xFF /*A*/);
//draw line
    SDL_RenderDrawLine(gRenderer, 20, 460, 620, 460);
